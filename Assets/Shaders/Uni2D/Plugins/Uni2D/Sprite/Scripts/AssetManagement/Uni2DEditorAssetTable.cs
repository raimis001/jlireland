...
public class Uni2DEditorAssetTable : ScriptableObject
{
	...
	public Dictionary<string, string> GetAllAtlasNames( )
	{
		...
		{
			oAtlasGUIDNameDict.Add( rKeyValuePair.Value, System.IO.Path.GetFileNameWithoutExtension( rKeyValuePair.Key ) );
		}
	...
	public Dictionary<string, string> GetAllClipNames( )
	{
		...
		{
			oClipGUIDNameDict.Add( rKeyValuePair.Value, System.IO.Path.GetFileNameWithoutExtension( rKeyValuePair.Key ) );
		}
