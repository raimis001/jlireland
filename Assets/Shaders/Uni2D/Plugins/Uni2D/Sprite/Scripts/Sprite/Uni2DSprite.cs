...
public class Uni2DSprite : MonoBehaviour 
{
	...
	private SkinnedMeshRenderer GoFromUnskinnedToSkinnedRenderer()
	{
		...
		if(rMeshRendererComponent != null)
		{
			...
			#if AFTER_UNITY_5
			rSkinnedMeshRendererComponent.shadowCastingMode = rMeshRendererComponent.shadowCastingMode;
			#else
	...
	private MeshRenderer GoFromSkinnedToUnskinnedRenderer()
	{
		...
		if(rSkinnedMeshRendererComponent != null)
		{
			...
			#if AFTER_UNITY_5
			rMeshRendererComponent.shadowCastingMode = rSkinnedMeshRendererComponent.shadowCastingMode;
			#else
		...
		if( iBoneCount > 0 )
		{
			...
			if(rSkinning != null)
			{
				...
				else
				{
					...
					#if AFTER_UNITY_4_3
					rSkinning.PolygonCollider2D = null;
					#endif
				}
